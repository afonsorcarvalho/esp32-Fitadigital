...
/** Buffers parciais (apenas se anti-tearing = 0): mais linhas = menos chamadas a flush e scroll mais fluido. */
#define LVGL_PORT_BUFFER_SIZE                   (LVGL_PORT_DISP_WIDTH * 48)
 ...
 */
/**
 * Waveshare 4.3B (ST7262) usa LCD RGB; o flush usa framebuffers do painel + VSYNC (GDMA no driver esp_lcd).
 * Modo 3 = double buffer + direct_mode (recomendado na documentação do port para LVGL >= 8.3.9).
 */
