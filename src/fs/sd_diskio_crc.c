/* Copiado de framework-arduinoespressif32/libraries/SD/src/sd_diskio_crc.c (Neil Thiessen, Apache-2.0).
 * Necessário ao usar `lib_ignore = SD` com `sd_diskio_waveshare.cpp`. */
